          ...
          {activeTab === 'FLASHCARD' && (
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="mt-4">
                  <label className="block text-sm font-medium text-slate-700 mb-2">{labels.batchSize}</label>
                  <input
                    type="range"
                    min="5"
                    max="50"
                  ...
                  <div className="flex justify-between text-xs text-slate-400 mt-1">
                    <span>5</span>
                    <span className="font-bold text-indigo-600">{localSettings.flashcard.batchSize}</span>
                    <span>50</span>
                  </div>
                </div>
              </div>
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="mt-4">
                  ...
                  <div className="flex justify-between text-xs text-slate-400 mt-1">
                    <span>5</span>
                    <span className="font-bold text-indigo-600">{localSettings.learn.batchSize}</span>
                    <span>50</span>
                  </div>
                </div>
              </div>
