...
export const LoginModal: React.FC<LoginModalProps> = ({
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Session Expired" size="sm" showCloseButton={false}>
      <div className="space-y-6">
        ...
        <button
          ...
          disabled={loading}
          type="button"
          className="w-full border border-slate-300 bg-white text-slate-700 py-2.5 rounded-lg font-medium hover:bg-slate-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-3"
        >
