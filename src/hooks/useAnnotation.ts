...
interface UseAnnotationReturn {
    ...
    saveAnnotation: (colorOverride?: string | null, noteOverride?: string, shouldCloseMenu?: boolean) => string | null;
...
export const useAnnotation = (
    ...
    const [selectedColor, setSelectedColor] = useState<'yellow' | 'green' | 'blue' | 'pink' | null>('yellow');
    ...
    const saveAnnotation = useCallback((colorOverride?: string | null, noteOverride?: string, shouldCloseMenu: boolean = true) => {
