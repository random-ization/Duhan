      ...
      <div className="flex-1 bg-white border-2 border-zinc-900 rounded-xl p-6 shadow-[4px_4px_0px_0px_#18181B] overflow-y-auto">
        {editingUnit ? (
          <div className="space-y-4 max-w-3xl mx-auto">
            ...
            <div className="flex gap-4">
              <div className="w-24">
                ...
                <input
                  ...
                  onChange={e =>
                    setEditingUnit({ ...editingUnit, unitIndex: parseInt(e.target.value) || 1 })
                  }
                />
              </div>
            ...
            {Boolean(editingUnit.analysisData) && (
              <div className="mt-6 p-4 bg-green-50 border-2 border-green-300 rounded-lg text-sm">
                ...
                <div className="text-green-700">
                  已生成{' '}
                  {Array.isArray(editingUnit.analysisData) ? editingUnit.analysisData.length : 0}{' '}
                  个词形映射数据。
                </div>
              </div>
            )}
