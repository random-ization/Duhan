...
import { BookOpen, Plus, Loader2, Trash2, Save, X, Palette } from 'lucide-react';
        ...
        <div className="flex h-[calc(100vh-200px)] gap-6">
          ...
          <div className="w-1/2 bg-white border-2 border-zinc-900 rounded-xl p-4 flex flex-col shadow-[4px_4px_0px_0px_#18181B]">
            ...
            <div className="flex-1 overflow-y-auto space-y-2">
              {institutes.length === 0 && status === 'LoadingMore' ? (
                ...
                <>
                  {institutes.map(inst => (
                    <div
                      key={inst.id}
                      className={`p-4 border-2 rounded-xl flex items-center gap-4 transition-all cursor-pointer ${
                        editingId === inst.id
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="font-bold text-zinc-900 truncate">
                          ...
                          {inst.volume && (
                            <span className="text-zinc-500 font-normal ml-1">{inst.volume}</span>
                          )}
                        </div>
