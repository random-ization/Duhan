        ...
        <div className="space-y-6">
                            ...
                            <div>
                                ...
                                <div className="text-sm text-zinc-500 mb-4">
                                    第 {stats.currentProgress.unit} 课 · {
                                        stats.currentProgress.module === 'vocab' ? '词汇' :
                                            stats.currentProgress.module === 'reading' ? '阅读' :
                                                stats.currentProgress.module === 'grammar' ? '语法' :
            ...
            <div className="bg-white border-2 border-zinc-900 rounded-xl p-6 shadow-[4px_4px_0px_0px_#18181B]">
                <div className="flex items-center justify-between mb-3">
                    ...
                    <span className="text-sm text-zinc-500">{stats.todayMinutes} / {stats.dailyGoal} 分钟</span>
                </div>
