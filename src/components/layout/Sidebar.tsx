            ...
            >
                ...
                <div className={`p-4 border-t-2 border-slate-100 flex ${collapsed ? 'flex-col' : ''} gap-2`}>
                    <button
                        ...
                        title={location.pathname === '/dashboard' && isEditing ? t('done') : t('sidebar.settings')}
