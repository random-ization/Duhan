...
import { Button, Dialog, DialogContent, DialogOverlay, DialogPortal, Input } from '../ui';
...
export default function GlobalCommandPaletteDialog({
  open,
  onOpenChange,
}: Readonly<GlobalCommandPaletteDialogProps>) {
  ...
  useEffect(() => {
    ...
    return () => globalThis.window.clearTimeout(focusTimer);
  }, [open]);
