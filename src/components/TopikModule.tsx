...
import {
  Clock, ArrowLeft, Check, X,
  MessageSquare, Trash2, Play, Pause, Trophy,
  Volume2, Loader2
} from 'lucide-react';
...
const TopikModule: React.FC<TopikModuleProps> = ({ exams, language, history: _history, onSaveHistory, annotations, onSaveAnnotation }) => {
