...
interface TopikEntryPageProps {
  canAccessContent: (content: any) => boolean;
  onShowUpgradePrompt: () => void;
}

export const TopikEntryPage: React.FC<TopikEntryPageProps> = ({
  canAccessContent,
  onShowUpgradePrompt,
}) => {
  ...
  if (isAuthenticated) {
    ...
    return (
      <TopikPage canAccessContent={canAccessContent} onShowUpgradePrompt={onShowUpgradePrompt} />
    );
  }
