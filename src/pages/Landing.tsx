  ...
  return (
    <>
      <SEO
        ...
        description="Master Korean with interactive lessons, TOPIK exam prep, authentic podcasts, and personalized learning. Join thousands of learners achieving fluency."
        canonical="/"
      />
