      ...
      <nav className="fixed top-0 left-0 right-0 z-50 px-6 py-4 flex justify-between items-center bg-white/70 backdrop-blur-xl border-b border-k-ink/5">
        <div className="max-w-7xl mx-auto w-full flex justify-between items-center">
          ...
          <div className="flex items-center gap-4">
            ...
            <span className="hidden md:block text-[12px] font-black tracking-[0.3em] text-k-ink uppercase">K-Soft · TOPIK Mastery</span>
          </div>
        </div>
      </nav>
      ...
      <div className="pt-32 pb-40">
        ...
        <header className="max-w-7xl mx-auto px-6 mb-24 text-center">
          ...
          >
            ...
            <span className="text-[11px] font-black text-k-crimson uppercase tracking-[0.2em]">Desktop Pro Experience</span>
          </motion.div>
          ...
          >
            专为大屏优化的考场模拟环境。不仅是真题，更是集成了 <span className="text-k-ink font-bold">AI 实时诊断、全维听力控制</span> 与 <span className="text-k-ink font-bold">写作提分实验室</span> 的一站式备考工作台。
          </motion.p>
        </header>

        {/* Desktop Interface Preview - The "Anti-Mobile" Visual */}
        <section className="max-w-7xl mx-auto px-6 mb-32">
          <Card pad={0} className="relative shadow-pop-lg overflow-hidden border border-k-ink/5 bg-white">
            ...
            <div className="h-12 bg-k-bg border-b border-k-ink/5 flex items-center px-6 justify-between">
              ...
              <div className="text-[10px] font-black tracking-widest text-k-sub uppercase">TOPIK II · Exam Environment</div>
              ...
              <div className="flex-1 p-10 overflow-y-auto border-r border-k-ink/5 bg-[#FDFCFB]">
                <div className="max-w-2xl mx-auto">
                  <div className="mb-8 flex items-center gap-3">
                    <span className="bg-k-ink text-white px-3 py-1 rounded-lg text-[12px] font-black">第 35~38 题</span>
                    <span className="text-k-sub text-[13px] font-bold">[阅读] 请选择最符合文章主旨的一项。</span>
                  </div>
                  <div className="space-y-6 text-[18px] leading-[1.8] text-k-ink font-medium">
                    <p>환경 보호를 위한 정부의 정책이 <span className="bg-[#F2D27A]/30 px-1 border-b-2 border-[#F2D27A]">본격적으로</span> 시행되면서 기업들은 탄소 배出량을 줄이기 위한 기술 개발에 박차를 가하고 있다.</p>
                    <p className="opacity-50">전문가들은 이러한 변화가 단순히 규제에 대응하는 것을 넘어, 새로운 시장 경쟁력을 확보하는 계기가 될 것이라고 전망하고 있다...</p>
                  </div>
                  <div className="mt-12 space-y-3">
                    {[
                      ...
                      <div key={i} className={`p-5 rounded-2xl border-2 transition-all cursor-pointer flex items-center gap-4 ${i === 3 ? 'border-k-crimson bg-k-crimson/5' : 'border-k-ink/5 bg-white hover:border-k-ink/20'}`}>
                        <div className={`w-6 h-6 rounded-full border-2 flex items-center justify-center text-[11px] font-black ${i === 3 ? 'bg-k-crimson border-k-crimson text-white' : 'border-k-ink/10 text-k-sub'}`}>{i + 1}</div>
                        <span className={`text-[15px] font-bold ${i === 3 ? 'text-k-ink' : 'text-k-sub'}`}>{opt}</span>
                      </div>
                    ))}
                  </div>
                </div>
              ...
              <div className="w-[380px] bg-white p-8 space-y-8 hidden lg:block">
                <div>
                  <div className="flex items-center gap-2 mb-6">
                    ...
                    <h3 className="text-[14px] font-black uppercase tracking-widest text-k-ink">AI Assistant</h3>
                  </div>
                ...
                <div>
                  <div className="flex items-center gap-2 mb-6">
                    ...
                    <h3 className="text-[14px] font-black uppercase tracking-widest text-k-ink">Progress Tracker</h3>
                  </div>
                  <div className="space-y-4">
                    <div className="flex justify-between items-end">
                      <span className="text-[11px] font-black text-k-sub">EXPECTED SCORE</span>
                      <span className="text-[28px] font-k-serif text-k-crimson leading-none">84<span className="text-[14px] ml-1">/100</span></span>
                    </div>
                ...
                <div className="pt-8 border-t border-k-ink/5">
                  <div className="text-[11px] font-black text-k-sub uppercase tracking-widest mb-4">Exam History</div>
        ...
        <div className="max-w-7xl mx-auto px-6 space-y-32">
          ...
          <section className="grid md:grid-cols-2 gap-20 items-center">
            <div>
              ...
              <h2 className="text-[36px] md:text-[52px] font-black text-k-ink mb-6 leading-tight">全真阅读环境：<br/>像专业考试一样刷题</h2>
          ...
          <section className="grid md:grid-cols-2 gap-20 items-center">
            <div className="order-2 md:order-1 bg-k-ink rounded-[40px] p-12 overflow-hidden relative min-h-[400px] flex items-center justify-center">
              <div className="absolute top-0 left-0 w-full h-full opacity-10" style={{ backgroundImage: 'radial-gradient(circle, #fff 1px, transparent 1px)', backgroundSize: '24px 24px' }} />
              <div className="relative z-10 flex flex-col items-center">
                <div className="flex gap-4 mb-8">
                  {[0.8, 1.0, 1.2, 1.5].map(v => (
                    <div key={v} className={`w-12 h-12 rounded-full border-2 flex items-center justify-center text-[11px] font-black ${v === 1.0 ? 'bg-k-crimson border-k-crimson text-white shadow-lg' : 'border-white/20 text-white/40'}`}>
                      {v}x
                    </div>
                  ))}
                </div>
            ...
            <div className="order-1 md:order-2">
              ...
              <h2 className="text-[36px] md:text-[52px] font-black text-k-ink mb-6 leading-tight">变速精听工作台：<br/>驯服每一个发音</h2>
              <ul className="space-y-8 mt-12">
                <FeatureItem 
                  title="无级变速控制" 
          ...
          <section className="bg-k-crimson rounded-[48px] p-12 md:p-24 text-white overflow-hidden relative">
            ...
            <div className="relative z-10">
              ...
              <div className="grid md:grid-cols-2 gap-16">
                <div>
                  <h2 className="text-[36px] md:text-[56px] font-black mb-8 leading-tight">不仅是 AI，<br/>更是你的考官</h2>
                  ...
                  <div className="space-y-8">
                    <div className="flex gap-6">
                      ...
                      <div>
                        ...
                        <p className="text-[15px] opacity-60 leading-relaxed">针对 TOPIK 54 题长作文，从语法、词汇、结构、逻辑四个维度给出精准改进建议，助你突破写作瓶颈。</p>
                      </div>
                    </div>
                    <div className="flex gap-6">
                      <div className="w-14 h-14 rounded-2xl bg-white/10 flex items-center justify-center shrink-0 border border-white/10">
                      ...
                      <div>
                        ...
                        <p className="text-[15px] opacity-60 leading-relaxed">基于你的每日练习数据与模考成绩，实时预测你的 TOPIK 等级概率，精准锁定备考盲区。</p>
                      </div>
                    </div>
                  </div>
                </div>
                   ...
                   <div className="relative w-full max-w-sm">
                      ...
                      <Card tone="white" className="relative shadow-2xl p-10 text-k-ink">
                        <div className="flex justify-between items-center mb-8">
                          <span className="text-[12px] font-black uppercase tracking-widest text-k-sub">AI Prediction</span>
                        ...
                        <div className="space-y-8">
                          <div>
                            <div className="flex justify-between mb-2">
                              ...
                              <span className="text-[14px] font-black text-k-crimson">TOPIK II · L5</span>
                            </div>
                          ...
                          <div className="grid grid-cols-2 gap-4">
                            <div className="p-4 bg-k-bg rounded-2xl text-center">
                              ...
                              <div className="text-[10px] font-black text-k-sub uppercase">Reading</div>
                            </div>
                            <div className="p-4 bg-k-bg rounded-2xl text-center">
                              <div className="text-[24px] font-k-serif font-bold">76</div>
                              <div className="text-[10px] font-black text-k-sub uppercase">Listening</div>
                            </div>
                          </div>
                        </div>
                      </Card>
          ...
          <section className="text-center pb-20">
            <h2 className="text-[32px] md:text-[64px] font-black text-k-ink mb-10 tracking-tighter">准备好在桌面端开启高效备考了吗？</h2>
...
const FeatureTag: React.FC<{ icon: React.ReactNode; label: string; color: string }> = ({ icon, label, color }) => (
  <div className="flex items-center gap-3 mb-6">
    <div className="p-2.5 rounded-xl" style={{ backgroundColor: `${color}15`, color }}>{icon}</div>
    <span className="text-[13px] font-black tracking-[0.2em] uppercase" style={{ color }}>{label}</span>
  </div>
);
...
const FeatureItem: React.FC<{ title: string; desc: string }> = ({ title, desc }) => (
  <li className="flex gap-6">
    ...
    <div>
      ...
      <p className="text-[15px] md:text-[16px] font-medium text-k-sub opacity-70 leading-relaxed">{desc}</p>
    </div>
  </li>
);
