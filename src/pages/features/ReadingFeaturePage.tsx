      ...
      <nav className="fixed top-0 left-0 right-0 z-50 px-6 py-4 flex justify-between items-center bg-white/70 backdrop-blur-xl border-b border-k-ink/5">
        <div className="max-w-7xl mx-auto w-full flex justify-between items-center">
          ...
          <div className="flex items-center gap-4">
            ...
            <span className="hidden md:block text-[12px] font-black tracking-[0.3em] text-k-ink uppercase">K-Soft · Graded Reading</span>
          </div>
        </div>
      </nav>
      ...
      <div className="pt-32 pb-40">
        ...
        <header className="max-w-7xl mx-auto px-6 mb-24 text-center">
          ...
          >
            ...
            <span className="text-[11px] font-black text-[#3D4A6B] uppercase tracking-[0.2em]">Step-by-Step Mastery</span>
          </motion.div>
          ...
          >
            从零到精读，<br className="hidden md:block"/>
          ...
          >
            阅读不应是查字典的苦旅。K-Soft 为你提供从 L1 到 L6 的科学分级素材，结合 AI 实时解析与背景知识库，让你在享受阅读的同时，词汇量与语感飞速增长。
          </motion.p>
        </header>
        ...
        <section className="max-w-7xl mx-auto px-6 mb-32">
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="w-full lg:w-64 space-y-3">
              <div className="text-[11px] font-black text-k-sub uppercase tracking-widest mb-4">Select Level</div>
              {[1, 2, 3, 4, 5, 6].map(lvl => (
                <div key={lvl} className={`p-4 rounded-2xl flex justify-between items-center cursor-pointer transition-all ${lvl === 3 ? 'bg-k-ink text-white shadow-lg' : 'bg-white text-k-ink hover:bg-k-bg border border-k-ink/5'}`}>
            ...
            <Card pad={0} className="flex-1 shadow-pop-lg overflow-hidden border border-k-ink/5 bg-white">
              <div className="p-10 md:p-16">
                 <div className="mb-10 flex items-center gap-4">
                    <Chip tone="crimson">LEVEL 3</Chip>
                    <span className="text-[14px] font-bold text-k-sub tracking-tight">2024年5月12日 · 社会新闻</span>
                 </div>
                 <h2 className="text-[32px] md:text-[42px] font-black text-k-ink mb-12 font-k-serif">서울의 숲에서 열리는 특별한 음악회</h2>
                 
                 <div className="space-y-10 text-[18px] md:text-[21px] leading-[2.0] text-k-ink font-medium">
                    <p className="relative group">
                      이번 주말 서울의 숲에서는 시민들을 위한 <span className="bg-[#F2D27A]/30 px-1 border-b-2 border-[#F2D27A] cursor-pointer">다채로운</span> 야외 음악회가 열립니다. 
                      <motion.div 
                      ...
                      >
                         ...
                         <div>
                            <div className="text-[12px] font-black text-[#F2D27A] uppercase mb-1">다채롭다 · 形容词</div>
                            <div className="text-[15px] font-bold">多种多样的、丰富多彩的</div>
                         </div>
                      </motion.div>
                    </p>
                    <p className="opacity-40">이번 음악회는 지역 사회의 화합을 위해 기획되었으며, 다양한 장르의 음악가들이 참여하여 관객들에게 잊지 못할 추억을 선사할 예정입니다...</p>
                 </div>

                 <div className="mt-20 pt-10 border-t border-k-bg flex flex-wrap gap-12">
                    <div>
                       <div className="text-[11px] font-black text-k-sub uppercase mb-2">Reading Time</div>
                       <div className="text-[20px] font-black text-k-ink">4.2 min</div>
                    </div>
                    <div>
                       <div className="text-[11px] font-black text-k-sub uppercase mb-2">New Vocab</div>
                       <div className="text-[20px] font-black text-k-crimson">12 cards</div>
                    </div>
                    <div>
                       <div className="text-[11px] font-black text-k-sub uppercase mb-2">Difficulty</div>
                       <div className="flex gap-1 mt-2">
                          {[1,2,3,4,5].map(i => <div key={i} className={`w-2 h-2 rounded-full ${i <= 3 ? 'bg-[#F2D27A]' : 'bg-k-bg'}`} />)}
                       </div>
                    </div>
                 </div>
              </div>
        ...
        <section className="max-w-7xl mx-auto px-6 space-y-32">
          ...
          <div className="grid md:grid-cols-2 gap-20 items-center">
            <div>
              ...
              <h2 className="text-[32px] md:text-[48px] font-black text-k-ink mb-6 leading-tight">AI 智能提词：<br/>哪里不会点哪里</h2>
              <p className="text-[18px] text-k-sub opacity-70 leading-relaxed mb-10">
                不再需要频繁切换查词软件。我们的 AI 会自动扫描全文，提前为你预判并标注生词，通过一键翻译和深度例句解析，扫清阅读障碍。
              </p>
              <ul className="space-y-6">
                <FeatureItem title="划词即翻译" desc="双击任何单词、词组甚至整个句子，AI 瞬间为你提供最地道的解释与变位参考。" />
                <FeatureItem title="背景知识百科" desc="遇到特定的人名、地名或文化专有名词？AI 实时提供背景信息，助你深度理解内容。" />
                <FeatureItem title="长难句一键剖析" desc="遇到看不懂的超长句子？AI 自动划分成分，解析语法点，让句意一目了然。" />
              </ul>
            </div>
            <div className="relative group">
               <div className="absolute -inset-10 bg-[#3D4A6B]/5 rounded-[60px] blur-3xl" />
               <Card tone="#3D4A6B" className="relative shadow-2xl p-12 text-white overflow-hidden min-h-[400px] flex flex-col justify-center">
                  ...
                  <p className="text-[16px] opacity-60 leading-relaxed">我们提供全方位的素材库：实时新闻、世界名著、韩国儿童绘本，满足从初学者到母语级水平的所有阅读需求。</p>
          ...
          <div className="bg-k-ink rounded-[48px] p-12 md:p-24 text-center text-white">
            ...
            <p className="max-w-2xl mx-auto text-[18px] md:text-[21px] font-medium opacity-60 leading-relaxed mb-12">
               分级阅读不仅是为了词汇量，更是为了通过阅读了解韩国的社会与文化。加入 K-Soft，享受阅读的乐趣。
            </p>
            <button 
