...
export default function PodcastDashboard() {
  ...
  const featuredPodcast =
    !lastPlayed && trending.internal.length > 0
      ? trending.internal[0]
      : trending.external.length > 0
        ? trending.external[0]
        : null;
      ...
      <div className="max-w-7xl mx-auto space-y-12">
        ...
        <div className="flex flex-col md:flex-row gap-4 mb-8">
          ...
          <div className="flex gap-2 overflow-x-auto scrollbar-hide pb-2 md:pb-0">
            <button className="px-4 py-3 bg-slate-900 text-white rounded-xl border-2 border-slate-900 font-bold text-sm whitespace-nowrap shadow-pop hover:translate-y-1 hover:shadow-none transition">
              {labels.common?.all || 'All'}
            </button>
            <button className="px-4 py-3 bg-white text-slate-600 rounded-xl border-2 border-slate-900 font-bold text-sm whitespace-nowrap hover:bg-slate-50 transition">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-4 bg-white rounded-[2rem] border-2 border-slate-900 p-6 shadow-pop h-fit sticky top-6">
            ...
            <div className="space-y-4 max-h-[500px] overflow-y-auto pr-1">
              {(activeTab === 'community' ? trending.internal : trending.external)
                .slice(0, 10)
                .map((pod, idx) => (
                  <div
                    key={idx}
              ...
              {!loading &&
                (activeTab === 'community' ? trending.internal : trending.external).length ===
                  0 && (
