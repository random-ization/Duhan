...
export const DesktopCoursesOverviewPage: React.FC = () => {
  ...
  // Oh, wait, in groupedCourses I omitted the filter logic. Let's fix that.
  ...
  }, [courses, searchQuery, getPublisherSearchValues]);

  const groupedCoursesFiltered = useMemo(() => {
  ...
  const groupedPublisherEntries = useMemo(() => {
    return Object.entries(groupedCoursesFiltered).sort(([publisherA, coursesA], [publisherB, coursesB]) => {
