...
export const PUBLIC_ROUTES = [
  ...
  },
  {
    ...
    noIndex: true,
    meta: {
      title: 'Sign In - DuHan Korean Learning',
      description: 'Sign in to DuHan and continue your Korean learning journey.',
      keywords: 'login, sign in, DuHan account',
    },
    metaByLang: {
      zh: {
        title: '登录 / 注册 - DuHan 韩语学习',
        description: '登录或注册 DuHan，继续你的韩语学习旅程。',
        keywords: '登录, 注册, DuHan 账号',
      },
      vi: {
        title: 'Đăng nhập / Đăng ký - DuHan học tiếng Hàn',
        description: 'Đăng nhập hoặc tạo tài khoản DuHan để tiếp tục hành trình học tiếng Hàn.',
        keywords: 'đăng nhập, đăng ký, tài khoản DuHan',
      },
      mn: {
        title: 'Нэвтрэх / Бүртгүүлэх - DuHan солонгос хэл',
        description: 'DuHan-д нэвтэрч эсвэл бүртгүүлээд солонгос хэлний суралцах аяллаа үргэлжлүүлээрэй.',
        keywords: 'нэвтрэх, бүртгүүлэх, DuHan бүртгэл',
      },
    },
  },
  {
