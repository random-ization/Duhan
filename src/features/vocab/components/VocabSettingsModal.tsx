...
type VocabSettingsDialogContentProps = Omit<VocabSettingsModalProps, 'isOpen'>;

function VocabSettingsDialogContent({
  settings,
  language,
  initialTab = 'FLASHCARD',
  onClose,
  onUpdate,
}: VocabSettingsDialogContentProps) {
  ...
  const handleSave = useCallback(() => {
    ...
    onClose();
  }, [localSettings, onClose, onUpdate]);
                    ...
                    <Switch
                      ...
                      onChange={() =>
                        setLocalSettings(current => ({
                          ...current,
                          flashcard: { ...current.flashcard, random: !current.flashcard.random },
                        }))
                      }
                    />
                    <Switch
                      ...
                      onChange={() =>
                        setLocalSettings(current => ({
                          ...current,
                          flashcard: { ...current.flashcard, autoTTS: !current.flashcard.autoTTS },
                        }))
                      }
                    />
                        ...
                        <div className="flex bg-muted p-1 rounded-lg">
                          <Button
                            ...
                            onClick={() =>
                              setLocalSettings(current => ({
                                ...current,
                                flashcard: { ...current.flashcard, cardFront: 'KOREAN' },
                              }))
                            }
                          ...
                          <Button
                            ...
                            onClick={() =>
                              setLocalSettings(current => ({
                                ...current,
                                flashcard: { ...current.flashcard, cardFront: 'NATIVE' },
                              }))
                            }
                            className={`px-3 py-1.5 text-xs font-bold rounded-md transition-all ${
                      ...
                      <div className="flex bg-muted p-1 rounded-lg">
                        <Button
                          ...
                          onClick={() =>
                            setLocalSettings(current => ({
                              ...current,
                              flashcard: { ...current.flashcard, ratingMode: 'PASS_FAIL' },
                            }))
                          }
                          className={`flex-1 px-3 py-2 text-sm font-bold rounded-md transition-all ${
                            localSettings.flashcard.ratingMode === 'PASS_FAIL'
                              ? 'bg-card shadow text-indigo-600'
                        ...
                        <Button
                          ...
                          onClick={() =>
                            setLocalSettings(current => ({
                              ...current,
                              flashcard: { ...current.flashcard, ratingMode: 'FOUR_BUTTONS' },
                            }))
                          }
                          className={`flex-1 px-3 py-2 text-sm font-bold rounded-md transition-all ${
                            localSettings.flashcard.ratingMode === 'FOUR_BUTTONS'
                              ? 'bg-card shadow text-indigo-600'
                              : 'text-muted-foreground hover:text-muted-foreground'
                          }`}
                        >
                  ...
                  <div>
                    ...
                    <Switch
                      ...
                      onChange={() =>
                        setLocalSettings(current => ({
                          ...current,
                          learn: { ...current.learn, random: !current.learn.random },
                        }))
                      }
                    />
                    ...
                    <div className="flex bg-muted p-1 rounded-lg">
                      <Button
                        ...
                        onClick={() =>
                          setLocalSettings(current => ({
                            ...current,
                            learn: { ...current.learn, ratingMode: 'PASS_FAIL' },
                          }))
                        }
                        className={`flex-1 px-3 py-2 text-sm font-bold rounded-md transition-all ${
                      ...
                      <Button
                        ...
                        onClick={() =>
                          setLocalSettings(current => ({
                            ...current,
                            learn: { ...current.learn, ratingMode: 'FOUR_BUTTONS' },
                          }))
                        }
                        className={`flex-1 px-3 py-2 text-sm font-bold rounded-md transition-all ${
