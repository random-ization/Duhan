            ...
            <header className="relative pt-40 pb-24 px-6 overflow-hidden">
                <div className="max-w-5xl mx-auto text-center z-10 relative">
                    ...
                    <h1 className="font-display text-5xl md:text-7xl leading-[1.1] mb-8 text-slate-900">
                        ...
                        </span> {t('landing.hero.titleSuffix')}
                    </h1>
            ...
            <div className="border-y-2 border-black bg-white py-12">
                <div className="max-w-6xl mx-auto px-6 grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
                    <div>
                        ...
                        <p className="font-bold text-slate-500 text-sm uppercase tracking-wider">{t('landing.stats.videos')}</p>
                    </div>
                    <div>
                        <p className="font-display text-4xl text-pink-500 mb-1">Level 1-6</p>
                        <p className="font-bold text-slate-500 text-sm uppercase tracking-wider">{t('landing.stats.curriculum')}</p>
                    </div>
                    <div>
                        <p className="font-display text-4xl text-yellow-500 mb-1">GPT-4</p>
                        <p className="font-bold text-slate-500 text-sm uppercase tracking-wider">{t('landing.stats.ai')}</p>
                    </div>
                    <div>
                        <p className="font-display text-4xl text-green-500 mb-1">TOPIK II</p>
                        <p className="font-bold text-slate-500 text-sm uppercase tracking-wider">{t('landing.stats.exam')}</p>
                    </div>
                </div>
            </div>
                    ...
                    <div className="md:w-1/2">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div className="bg-slate-50 p-4 rounded-xl border-2 border-slate-200">
                                <h4 className="font-display font-bold mb-1">{t('landing.features.institute.beginner')}</h4>
                                <p className="text-sm text-slate-500">{t('landing.features.institute.beginnerDesc')}</p>
                            </div>
                            <div className="bg-slate-50 p-4 rounded-xl border-2 border-slate-200">
                                <h4 className="font-display font-bold mb-1">{t('landing.features.institute.intermediate')}</h4>
                                <p className="text-sm text-slate-500">{t('landing.features.institute.intermediateDesc')}</p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div className="relative bg-white border-2 border-black rounded-3xl p-6 shadow-pop-card">
                            ...
                            <div className="bg-green-50 border-2 border-green-200 rounded-xl p-4 relative">
                                ...
                                <p className="text-sm text-slate-700">
                                    {t('landing.mock.feedbackContent')}
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="md:w-1/2">
                        ...
                        <div className="grid grid-cols-1 gap-4">
                            <div className="bg-slate-50 p-4 rounded-xl border-2 border-slate-200 flex gap-4 hover:border-pink-300 transition-colors">
                                ...
                                <div>
                                    <h4 className="font-display font-bold text-slate-900">{t('landing.features.topik.point1')}</h4>
                                </div>
                            </div>
                            <div className="bg-slate-50 p-4 rounded-xl border-2 border-slate-200 flex gap-4 hover:border-pink-300 transition-colors">
                                <div className="w-10 h-10 bg-white rounded-lg border border-slate-200 flex items-center justify-center font-bold text-lg">📊</div>
                                <div>
                                    <h4 className="font-display font-bold text-slate-900">{t('landing.features.topik.point2')}</h4>
                                </div>
                            </div>
                            <div className="bg-slate-50 p-4 rounded-xl border-2 border-slate-200 flex gap-4 hover:border-pink-300 transition-colors">
                                <div className="w-10 h-10 bg-white rounded-lg border border-slate-200 flex items-center justify-center font-bold text-lg">🕒</div>
                                <div>
                                    <h4 className="font-display font-bold text-slate-900">{t('landing.features.topik.point3')}</h4>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section id="pricing" className="py-24 px-6 relative">
                <div className="max-w-5xl mx-auto">
                    <div className="text-center mb-16">
                        <h2 className="font-display text-4xl md:text-5xl mb-4 text-slate-900">{t('landing.pricing.title')}</h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
                        ...
                        <div className="bg-indigo-500 p-8 rounded-3xl border-2 border-black shadow-pop-card relative transform md:-translate-y-4 md:scale-105 z-10">
                            ...
                            <h3 className="font-display text-xl text-white mb-4">{t('landing.pricing.annual')}</h3>
                            ...
                            <p className="text-sm text-white/80 font-bold mb-8">{t('landing.pricing.equivalent')}</p>
                            <button
                                onClick={() => navigate('/register')}
            ...
            <footer className="bg-white border-t-2 border-black py-12 px-6 mt-12">
                <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
                    ...
                    <div className="flex gap-8 text-sm font-bold text-slate-500">
                        <Link to="/privacy" className="hover:text-black">{t('common.privacy')}</Link>
                        <Link to="/terms" className="hover:text-black">{t('common.terms')}</Link>
                        <a href="mailto:support@koreanstudy.me" className="hover:text-black">{t('common.contact')}</a>
                    </div>
                </div>
            </footer>
        </div>
